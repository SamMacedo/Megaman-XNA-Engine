...
{
    /// <summary>
    /// Clase representante de las plataformas rojas que se impulsan hacia arriba
    /// </summary>
    public sealed class UpPlatform : MovingPlatform
    {
        #region Campos
        ...
        public UpPlatform(Megaman megaman, Vector2 initialPosition)
        ...
        {
            animations = Resources.ANIM_UpPlatform.CreateCopy();
        }
            ...
            if (activated)
            {
                ...
                if (onBounce)
                {
                    ...
                    if (bounceTime >= MaxBounceTime)
                    {
                        ...
                        Resources.SFX_UpMovingPlatform.Play();
                    }
                }
                else
                {
